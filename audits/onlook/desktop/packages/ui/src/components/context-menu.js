...
const ContextMenu = ({ ...props }) => (<ContextMenuPrimitive.Root modal={false} // Setting modal to false allows clicks outside the menu to dismiss it, including canvas clicks
 {...props}/>);
