...
exports.CREATE_PAGE_EXAMPLE_CONVERSATION = exports.assistant1 = void 0;
const format_1 = require("../format");
const user1 = 'Create beautiful landing page with minimalist UI';
exports.assistant1 = `${format_1.FENCE.code.start}
'use client';
...
exports.CREATE_PAGE_EXAMPLE_CONVERSATION = [
    {
        role: 'user',
        content: user1,
    },
