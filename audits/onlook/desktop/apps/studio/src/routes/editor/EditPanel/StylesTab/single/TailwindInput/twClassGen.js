...
exports.coreColors = void 0;
exports.getAllTailwindClasses = getAllTailwindClasses;
exports.searchTailwindClasses = searchTailwindClasses;
exports.getClassesByCategory = getClassesByCategory;
...
function generateSpacingClasses(prefix) {
    const sizes = [
        '0',
        '0.5',
        '1',
...
function generateColors(prefix) {
    const shades = ['50', '100', '200', '300', '400', '500', '600', '700', '800', '900'];
    return exports.coreColors.flatMap((color) => shades.map((shade) => `${prefix}-${color}-${shade}`));
}
function generateOpacityClasses(prefix) {
    const opacities = [
        '0',
        '5',
        '10',
...
function generateGridClasses(prefix, max) {
    return Array.from({ length: max }, (_, i) => `${prefix}-${i + 1}`);
}
function generateDurationClasses() {
...
function getAllTailwindClasses() {
    ...
    function addClassesFromObject(obj) {
        for (const key in obj) {
            if (Array.isArray(obj[key])) {
                obj[key].forEach((cls) => allClasses.add(cls));
            }
...
function searchTailwindClasses(input) {
...
function getContextualSuggestions(currentClasses) {
...
//# sourceMappingURL=twClassGen.js.map