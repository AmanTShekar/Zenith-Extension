...
exports.ElementsManager = void 0;
...
class ElementsManager {
    ...
    mouseover(domEl) {
        ...
        const adjustedRect = (0, utils_1.adaptRectToCanvas)(frameEl.rect, view);
    ...
    click(domEls) {
        ...
        for (const domEl of domEls) {
            ...
            const adjustedRect = (0, utils_1.adaptRectToCanvas)(domEl.rect, view);
            const isComponent = !!domEl.instanceId;
            this.editorEngine.overlay.state.addClickRect(adjustedRect, domEl.styles, isComponent, domEl.domId);
    ...
    emitError(error) {
        console.error(error);
        sonner_1.toast.error('Cannot delete element', { description: error });
    }
    async delete() {
    ...
    async shouldDelete(selectedEl, frameData) {
