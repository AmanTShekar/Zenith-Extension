...
exports.getRelativeMousePositionToFrameView = getRelativeMousePositionToFrameView;
 ...
 */
function adaptRectToCanvas(rect, frameView, inverse = false) {
 ...
 */
function getRelativeMousePositionToFrameView(e, frameView, inverse = false) {
