...
exports.addTailwindNestedColor = addTailwindNestedColor;
exports.addTailwindCssVariable = addTailwindCssVariable;
exports.updateTailwindCssVariable = updateTailwindCssVariable;
exports.extractTailwindCssVariables = extractTailwindCssVariables;
exports.extractColorsFromTailwindConfig = extractColorsFromTailwindConfig;
exports.isValidTailwindConfigProperty = isValidTailwindConfigProperty;
            ...
            Once(root) {
                ...
                root.walkRules(/^(:root|\.dark)$/, (rule) => {
                    ...
                    const shouldUpdateValue = newColor &&
                        (!theme ||
                            (isDarkTheme
                                ? theme === assets_1.SystemTheme.DARK
                                : theme === assets_1.SystemTheme.LIGHT));
                    rule.walkDecls((decl) => {
...
function modifyTailwindConfig(configContent, modifier) {
    ...
    const output = (0, parser_1.generate)(updateAst, { retainLines: true, compact: false }, configContent).code;
