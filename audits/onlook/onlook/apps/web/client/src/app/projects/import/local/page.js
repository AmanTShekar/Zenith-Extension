...
const cancel_button_1 = require("../cancel-button");
const finalizing_project_1 = require("./_components/finalizing-project");
const select_folder_1 = require("./_components/select-folder");
    ...
    return (<div className="w-screen h-screen flex flex-col" style={{
            ...
            <div className="flex items-center justify-between px-12 py-4">
                <link_1.default href={constants_1.Routes.HOME}>
                    <icons_1.Icons.OnlookTextLogo className="h-3"/>
                </link_1.default>
                <cancel_button_1.CancelButton />
            </div>
            <div className="relative w-full h-full flex items-center justify-center">
                <div className="relative z-10">
                    <react_1.MotionConfig transition={{ duration: 0.5, type: 'spring', bounce: 0 }}>
                        <motion_card_1.MotionCard initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} exit={{ opacity: 0, y: 20 }} className="w-[30rem] min-h-[12rem] overflow-hidden p-0 border border-primary/20 rounded-lg shadow-lg !bg-background">
