...
const FontFamily = ({ name, variants = [], onAddFont, onRemoveFont, onSetDefault, onClearDefault, showDropdown = false, showAddButton = true, isDefault = false, }) => {
    ...
    return (<div className="w-full group">
            <div className="flex justify-between items-center py-3">
                <div className="flex flex-1 items-center cursor-pointer max-w-52" onClick={() => setExpanded(!expanded)}>
                    ...
                    <span className={`text-sm truncate transition-opacity duration-200`} style={{ fontFamily: name }}>
                        {name}
                    </span>
                ...
                <div className="flex items-center opacity-0 group-hover:opacity-100 transition-opacity duration-100">
                    ...
                    {showDropdown && (<dropdown_menu_1.DropdownMenu modal={false}>
                            ...
                            <dropdown_menu_1.DropdownMenuContent align="end" className="min-w-fit">
                                <dropdown_menu_1.DropdownMenuItem onClick={handleToggleDefault} className="flex items-center pr-2 cursor-pointer">
                                    <icons_1.Icons.Check className={(0, utils_1.cn)("h-4 w-4 mr-2", isDefault ? "opacity-100" : "opacity-0")}/>
            ...
            {expanded && variants.length > 0 && (<div className="pl-7 flex flex-col gap-2 pb-6" style={{
                fontFamily: name,
            }}>
