...
exports.ObsessForHoursSection = ObsessForHoursSection;
const fonts_1 = require("../../fonts");
function ObsessForHoursSection() {
    return (<div className="w-full mx-auto py-32 px-8 flex bg-background-onlook/80 flex-col md:flex-row items-start gap-24 md:gap-12">
            <div className="w-full max-w-6xl mx-auto flex flex-col gap-12">
                ...
                <div className="w-full flex flex-col items-center justify-center mb-12 md:flex-row md:gap-1">
                    ...
                    <span className={`text-foreground-primary ${fonts_1.vujahdayScript.className} text-6xl leading-[1.1] font-light md:ml-3 md:mr-3 mt-2 md:mt-0`}>Seconds</span>
                    ...
                    <span className={`text-foreground-primary ${fonts_1.vujahdayScript.className} text-6xl leading-[1.1] font-light md:ml-0 md:mt-0 hidden md:block`}>Hours</span>
                    ...
                    <div className="flex flex-col items-center text-center w-full md:hidden mt-8">
                        ...
                        <span className={`text-foreground-primary ${fonts_1.vujahdayScript.className} text-6xl leading-[1.1] font-light mt-2`}>Hours</span>
                    </div>
                </div>
                {/* Subtext blocks */}
...
//# sourceMappingURL=obsess-for-hours-section.js.map