...
exports.AiFeaturesIntroSection = AiFeaturesIntroSection;
const react_1 = __importDefault(require("react"));
function AiFeaturesIntroSection() {
    return (<div className="w-full max-w-6xl mx-auto py-32 px-8 text-center">
...
//# sourceMappingURL=ai-features-intro-section.js.map