...
const color_picker_1 = require("../../../../editor-bar/inputs/color-picker");
    ...
    return (<popover_1.Popover onOpenChange={(open) => !open && handleNameChange(editedName)} open={true}>
            ...
            <popover_1.PopoverContent className="p-0 w-56" side="right" align="start">
                <div className="flex flex-col gap-0 p-0">
                    <div className="flex flex-col gap-1 p-2 pb-1">
                        ...
                        <color_name_input_1.ColorNameInput initialName={editedName} onSubmit={handleNameChange} onCancel={() => {
            ...
            if (onClose) {
                onClose();
                    ...
                    <color_picker_1.ColorPickerContent color={editedColor} onChange={handleColorChange} onChangeEnd={handleColorChange} isCreatingNewColor/>
                </div>
            </popover_1.PopoverContent>
        </popover_1.Popover>);
};
exports.ColorPopover = ColorPopover;
//# sourceMappingURL=color-popover.js.map