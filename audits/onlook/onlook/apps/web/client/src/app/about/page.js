...
const website_layout_1 = require("@/app/_components/website-layout");
const hooks_1 = require("@onlook/ui/hooks");
const icons_1 = require("@onlook/ui/icons");
const react_1 = require("motion/react");
const react_2 = require("react");
const use_parallax_cursor_1 = require("../../hooks/use-parallax-cursor");
...
function AboutPage() {
    const { raw: starCount, contributors } = (0, github_1.useGitHubStats)();
    const parallax = (0, use_parallax_cursor_1.useParallaxCursor)({ intensity: 0.15, smoothness: 0.08 });
    const prefersReducedMotion = (0, hooks_1.useReducedMotion)();
    // Responsive state for mobile detection
    const [isMobile, setIsMobile] = (0, react_2.useState)(false);
    (0, react_2.useEffect)(() => {
        const checkMobile = () => {
    ...
    const firstSquareRef = (0, react_2.useRef)(null);
    const lastSquareRef = (0, react_2.useRef)(null);
    const [lineStyle, setLineStyle] = (0, react_2.useState)({ top: 0, height: 0 });
    ...
    const getBlurAnimationProps = (delay = 0, includeStyle = true, customViewport) => {
        const baseProps = {
            ...
            <main className="bg-background text-foreground-primary">
                ...
                <section className="py-64 bg-black text-foreground-primary">
                    <div className="max-w-6xl mx-auto px-8">
                        <react_1.motion.h1 className="text-6xl font-light leading-tight mb-24 text-left" {...getBlurAnimationProps()}>
                            Design deserves<br />better tools
                        </react_1.motion.h1>

                        {/* Stats - shown below title on mobile/midsize, hidden on large screens */}
                        <react_1.motion.div className="block lg:hidden mb-24" {...getBlurAnimationProps(0.1)}>
                        ...
                        <div className="flex gap-12 flex-col md:flex-row md:items-start md:justify-between">
                            <react_1.motion.div className=" max-w-lg text-left" {...getBlurAnimationProps(0.2)}>
                            ...
                            <react_1.motion.div className="flex flex-col mt-12 lg:mt-0 hidden lg:block md:w-[340px] md:ml-auto" {...getBlurAnimationProps(0.3)}>
                ...
                <section className="py-48">
                    <div className="max-w-6xl mx-auto px-8">
                        <div className="text-left mb-24">
                            <react_1.motion.h2 className="text-7xl font-light leading-tight mb-12 text-left" initial={{ opacity: 0, filter: "blur(4px)" }} whileInView={{ opacity: 1, filter: "blur(0px)" }} viewport={{ once: true, margin: "-100px 0px -100px 0px", amount: 0.3 }} transition={{ duration: 0.6, ease: "easeOut" }} style={{ willChange: "opacity, filter", transform: "translateZ(0)" }}>
                                Meet the <span className={fonts_1.vujahdayScript.className + ' text-8xl ml-1 font-normal'}>founders</span>
                            </react_1.motion.h2>
                            <react_1.motion.p className="text-lg md:text-large font-light text-foreground-secondary max-w-xl mt-8 mb-12 text-balance" initial={{ opacity: 0, filter: "blur(4px)" }} whileInView={{ opacity: 1, filter: "blur(0px)" }} viewport={{ once: true, margin: "-100px 0px -100px 0px", amount: 0.3 }} transition={{ duration: 0.6, delay: 0.3, ease: "easeOut" }} style={{ willChange: "opacity, filter", transform: "translateZ(0)" }}>
                            ...
                            <react_1.motion.div className="flex justify-start mt-8" initial={{ opacity: 0, filter: "blur(4px)" }} whileInView={{ opacity: 1, filter: "blur(0px)" }} viewport={{ once: true, margin: "-100px 0px -100px 0px", amount: 0.3 }} transition={{ duration: 0.6, delay: 0.5, ease: "easeOut" }} style={{ willChange: "opacity, filter", transform: "translateZ(0)" }}>
                                <button_link_1.ButtonLink href="https://onlook.substack.com" target="_blank" rel="noopener noreferrer" rightIcon={<span className="ml-2">→</span>}>
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-x-16 gap-y-12">
                            {/* Founder 1 */}
                            <react_1.motion.div className="flex gap-8 items-start rounded-2xl" {...getBlurAnimationProps(0.7)}>
                                ...
                                <div className="flex flex-col">
                                    ...
                                    <div className="flex md:gap-3 gap-6 items-center">
                                        <a href="https://github.com/drfarrell" target="_blank" rel="noopener noreferrer" aria-label="Daniel's GitHub">
                                            <icons_1.Icons.GitHubLogo className="w-6.5 md:w-4.5 h-6.5 md:h-4.5 text-foreground-secondary hover:text-foreground-primary transition-colors"/>
                                        </a>
                                        <a href="https://www.linkedin.com/in/danielrfarrell/" target="_blank" rel="noopener noreferrer" aria-label="Daniel's LinkedIn">
                                            <icons_1.Icons.SocialLinkedIn className="w-7 md:w-5 h-7 md:h-5 text-foreground-secondary hover:text-foreground-primary transition-colors"/>
                                        </a>
                                        <a href="https://x.com/D_R_Farrell" target="_blank" rel="noopener noreferrer" aria-label="Daniel's X">
                                            <icons_1.Icons.SocialX className="w-7 md:w-5 h-7 md:h-5 text-foreground-secondary hover:text-foreground-primary transition-colors"/>
                                        </a>
                                    </div>
                                </div>
                            </react_1.motion.div>
                            {/* Founder 2 */}
                            <react_1.motion.div className="flex gap-8 items-start rounded-2xl" {...getBlurAnimationProps(0.9)}>
                ...
                <section className="relative w-full min-h-[80vh] bg-black flex flex-col items-center justify-center py-20 md:py-80 overflow-x-clip">
                    <div className="w-full mx-auto flex flex-col gap-16 md:gap-36 px-3 md:px-0">
                        ...
                        <div className="flex max-w-5xl mx-auto flex-col md:flex-row items-center justify-between w-full relative">
                            <react_1.motion.div className="pl-0 md:pl-12 mb-12 md:mb-0 w-full" {...getBlurAnimationProps()}>
                                <h2 className="text-white text-5xl md:text-6xl font-light leading-tight mb-0 ">
                                    Welcome to<br />headquarters
                                </h2>
                            </react_1.motion.div>
                            {/* Desktop only image */}
                            <react_1.motion.img src="/assets/about-office-1.png" alt="Office space" className="hidden md:block w-[400px] h-[400px] object-cover mb-0 transition-transform duration-300 ease-out pointer-events-none select-none" style={{
                        ...
                        <div className="md:hidden w-full">
                            ...
                            <div className="grid grid-cols-1 gap-4 mb-4">
                                ...
                                <div className="space-y-4">
                                    <react_1.motion.img src="/assets/about-office-1.png" alt="Office space" className="w-full h-100 object-cover transition-transform duration-300 ease-out pointer-events-none select-none" {...getBlurAnimationProps(0.1, false, {
        once: true,
        margin: isMobile ? "-50px 0px -50px 0px" : "-100px 0px -100px 0px",
        amount: isMobile ? 0.1 : 0.3
    })}/>
                                    <react_1.motion.img src="/assets/about-office-3.png" alt="Office space" className="w-full h-100 object-cover transition-transform duration-300 ease-out pointer-events-none select-none" {...getBlurAnimationProps(0.2, false, {
        once: true,
        margin: isMobile ? "-50px 0px -50px 0px" : "-100px 0px -100px 0px",
        amount: isMobile ? 0.1 : 0.3
    })}/>
                                ...
                                <div className="space-y-4">
                                    <react_1.motion.img src="/assets/about-office-2.png" alt="Office space" className="w-full h-100 object-cover transition-transform duration-300 ease-out pointer-events-none select-none" {...getBlurAnimationProps(0.3, false, {
        once: true,
        margin: isMobile ? "-50px 0px -50px 0px" : "-100px 0px -100px 0px",
        amount: isMobile ? 0.1 : 0.3
    })}/>
                            ...
                            <react_1.motion.div className="flex flex-col items-start justify-center text-white text-left px-12 py-48 mb-4" {...getBlurAnimationProps(0.2)}>
                                ...
                                <button_link_1.ButtonLink href="https://www.ycombinator.com/companies/onlook/jobs/e4gHv1n-founding-engineer-fullstack" target="_blank" rel="noopener noreferrer" rightIcon={<span className="ml-2">→</span>}>
                                    Claim your desk
                                </button_link_1.ButtonLink>
                            </react_1.motion.div>
                            ...
                            <div className="flex flex-col justify-center gap-4">
                                <react_1.motion.img src="/assets/about-office-5.png" alt="Office space" className="w-full h-100 object-cover transition-transform duration-300 ease-out pointer-events-none select-none" {...getBlurAnimationProps(0.4, false, {
        once: true,
        margin: isMobile ? "-50px 0px -50px 0px" : "-100px 0px -100px 0px",
        amount: isMobile ? 0.1 : 0.3
    })}/>
                                <react_1.motion.img src="/assets/about-office-4.png" alt="Office space" className="w-full h-100 object-cover transition-transform duration-300 ease-out pointer-events-none select-none" {...getBlurAnimationProps(0.5, false, {
        once: true,
        margin: isMobile ? "-50px 0px -50px 0px" : "-100px 0px -100px 0px",
        amount: isMobile ? 0.1 : 0.3
    })}/>
                        ...
                        <div className="hidden md:block">
                            ...
                            <div className="flex flex-row items-center justify-center gap-40 w-full relative max-w-8xl">
                                <react_1.motion.img src="/assets/about-office-2.png" alt="Office space" className="w-[400px] h-[400px] object-cover relative bottom-[60px] ml-12 transition-transform duration-300 ease-out pointer-events-none select-none" style={{
            transform: `translate(${parallax.x * -50}px, ${parallax.y * 80}px)`,
            willChange: prefersReducedMotion ? "opacity" : "opacity, filter"
        }} {...getBlurAnimationProps(0.1, false)}/>
                                <react_1.motion.div className="flex flex-col items-start justify-center text-white text-regular text-left min-w-[400px] px-8 relative left-24" {...getBlurAnimationProps(0.2)}>
                                ...
                                <react_1.motion.img src="/assets/about-office-3.png" alt="Office space" className="w-[400px] h-[400px] object-cover transition-transform duration-300 ease-out pointer-events-none select-none" style={{
            ...
            willChange: prefersReducedMotion ? "opacity" : "opacity, filter"
                            ...
                            <div className="flex flex-row items-center justify-center gap-60 pt-12">
                                <react_1.motion.div className="w-[400px] aspect-square relative -ml-70 top-48 transition-transform duration-300 ease-out" style={{
            transform: `translate(${parallax.x * -70}px, ${parallax.y * 60}px)`,
            willChange: prefersReducedMotion ? "opacity" : "opacity, filter"
        }} {...getBlurAnimationProps(0.4, false)}>
                                    <react_1.motion.img src="/assets/about-office-4.png" alt="Office space" className="w-full h-full object-cover pointer-events-none select-none" {...getBlurAnimationProps(0.4, false)}/>
                                </react_1.motion.div>
                                <react_1.motion.img src="/assets/about-office-5.png" alt="Office space" className="w-[400px] h-[400px] object-cover relative left-20 top-24 transition-transform duration-300 ease-out pointer-events-none select-none" style={{
            ...
            willChange: prefersReducedMotion ? "opacity" : "opacity, filter"
                ...
                <section className="py-60 bg-black text-foreground-primary">
                    <div className="max-w-6xl mx-auto px-8">
                        <react_1.motion.h2 className="text-7xl font-light leading-tight mb-20 text-left" {...getBlurAnimationProps()}>
                            What we <span className={fonts_1.vujahdayScript.className + ' text-8xl ml-1 font-normal'}>reward</span>
                        </react_1.motion.h2>
                        <div className="grid grid-cols-2 md:grid-cols-4 gap-y-16 md:gap-x-24 gap-x-12 mb-16">
                            {/* Speed */}
                            <react_1.motion.div className="flex flex-col items-start text-left" {...getBlurAnimationProps(0.1)}>
                                <illustrations_1.Illustrations.AboutSpeed className="w-26 h-20 mb-6 text-foreground-primary"/>
                            ...
                            {/* Resilience */}
                            <react_1.motion.div className="flex flex-col items-start text-left" {...getBlurAnimationProps(0.2)}>
                                <illustrations_1.Illustrations.AboutResilience className="w-20 h-20 mb-6 text-foreground-primary"/>
                            ...
                            {/* Reinvention */}
                            <react_1.motion.div className="flex flex-col items-start text-left" {...getBlurAnimationProps(0.3)}>
                                <illustrations_1.Illustrations.AboutReinvention className="w-20 h-20 mb-6 text-foreground-primary"/>
                            ...
                            {/* Competence */}
                            <react_1.motion.div className="flex flex-col items-start text-left" {...getBlurAnimationProps(0.4)}>
                                <illustrations_1.Illustrations.AboutCompetence className="w-20 h-20 mb-6 py-4 pr-3 text-foreground-primary"/>
                        ...
                        <react_1.motion.div className="flex justify-start" {...getBlurAnimationProps(0.5)}>
                            <button_link_1.ButtonLink href="https://www.ycombinator.com/companies/onlook/jobs/e4gHv1n-founding-engineer-fullstack" target="_blank" rel="noopener noreferrer" rightIcon={<span className="ml-2">→</span>}>
                                Browse open roles
                            </button_link_1.ButtonLink>
                        </react_1.motion.div>
                ...
                <section className="py-56 bg-black text-foreground-primary">
                    <div className="max-w-6xl mx-auto px-8">
                        <react_1.motion.h2 className="text-7xl font-light leading-tight mb-20 text-left" {...getBlurAnimationProps()}>
                            What we <span className={fonts_1.vujahdayScript.className + ' text-8xl ml-1 font-normal'}>look&nbsp;for</span>
                        </react_1.motion.h2>
                ...
                <section className="py-56 bg-black text-foreground-primary">
                    <div className="max-w-6xl mx-auto px-8 flex flex-col md:flex-row justify-between gap-32">
                        ...
                        <div className="flex flex-col items-start justify-start mb-16 md:mb-0">
                            <react_1.motion.h2 className="text-7xl font-light leading-tight mb-12 text-left" {...getBlurAnimationProps()}>
                                Join the Odyssey
                            </react_1.motion.h2>
                            <react_1.motion.div {...getBlurAnimationProps(0.1)}>
                                <button_link_1.ButtonLink href="https://www.ycombinator.com/companies/onlook/jobs/e4gHv1n-founding-engineer-fullstack" target="_blank" rel="noopener noreferrer" rightIcon={<span className="ml-2">→</span>}>
                                    Take the leap
                                </button_link_1.ButtonLink>
                            </react_1.motion.div>
                        ...
                        <div className="relative max-w-[500px]">
                            ...
                            <div className="relative flex flex-col" ref={timelineContainerRef}>
                                ...
                                <div className="absolute left-0 w-px bg-foreground-primary/20 z-0" style={{ top: lineStyle.top, height: lineStyle.height }}/>
                                {/* Vertical shimmer overlay */}
                                <div className="absolute left-0 w-px bg-gradient-to-b from-transparent via-white/60 to-transparent bg-[length:100%_200%] animate-shimmer-vertical z-10" style={{ top: lineStyle.top, height: lineStyle.height }}/>
                                <div className="relative z-10 flex flex-col gap-0">
                                    {/* Step 1: Apply directly */}
                                    <react_1.motion.div className="flex flex-row items-start mb-16 relative" {...getBlurAnimationProps(0.2)}>
                                    ...
                                    <react_1.motion.div className="flex flex-row items-start mb-16 relative" {...getBlurAnimationProps(0.3)}>
                                    ...
                                    <react_1.motion.div className="flex flex-row items-start mb-16 relative" {...getBlurAnimationProps(0.4)}>
                                        <div className="w-3 h-3 bg-foreground-tertiary absolute left-0 top-2 transform -translate-x-1/2"/>
                                        <div className="ml-12">
                                    ...
                                    <react_1.motion.div className="flex flex-row items-start mb-16 relative" {...getBlurAnimationProps(0.5)}>
                                        <div className="w-3 h-3 bg-foreground-tertiary absolute left-0 top-2 transform -translate-x-1/2"/>
                                        <div className="ml-12">
                                    ...
                                    <react_1.motion.div className="flex flex-row items-start mb-16 relative" {...getBlurAnimationProps(0.6)}>
                                        <div className="w-3 h-3 bg-foreground-tertiary absolute left-0 top-2 transform -translate-x-1/2"/>
                                        <div className="ml-12">
                                    ...
                                    {/* Step 6: Offer */}
                                    <react_1.motion.div className="flex flex-row items-start relative" {...getBlurAnimationProps(0.7)}>
            ...
            <cta_section_1.CTASection href="https://www.ycombinator.com/companies/onlook/jobs/e4gHv1n-founding-engineer-fullstack" ctaText="Apply today" buttonText="Browse open roles" showSubtext={false}/>
