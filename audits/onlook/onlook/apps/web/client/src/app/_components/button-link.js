...
function ButtonLink({ href, children, rightIcon, target, rel }) {
    return (<div className="relative inline-block group">
            <a href={href} target={target} rel={rel} className="text-foreground-secondary text-regular flex items-center gap-2 pb-2 hover:text-foreground-primary transition-colors" style={{ width: 'fit-content' }}>
                {children}
