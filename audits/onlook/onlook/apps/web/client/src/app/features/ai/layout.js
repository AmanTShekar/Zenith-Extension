...
exports.default = AiFeaturesLayout;
exports.metadata = {
    title: 'AI Visual Editor | Build UIs with AI Using Your Design System | Onlook',
    description: 'Onlook is an AI-powered visual editor that builds frontend UIs using your real React components. AI is constrained to your design system — no brand drift, no throwaway code. Changes become mergeable PRs.',
    keywords: [
        // Primary keywords
        'AI visual editor',
        'AI UI builder',
    ...
    openGraph: {
        ...
        description: 'Build frontend UIs with AI constrained to your design system. Your real components. Mergeable PRs, not throwaway code.',
        type: 'website',
...
const jsonLd = {
    ...
    operatingSystem: 'Web',
    description: 'Onlook is an AI-powered visual editor that builds frontend UIs using your real React, Vue, or Angular components. AI is constrained to your design system. Changes become mergeable pull requests.',
    url: 'https://onlook.com/features/ai',
    featureList: [
...
function AiFeaturesLayout({ children }) {
    return (<>
