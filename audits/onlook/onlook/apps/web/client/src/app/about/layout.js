...
exports.metadata = {
    ...
    description: 'Meet the team behind Onlook — an AI-powered visual editor for frontend development. Founded to obliterate the divide between creativity and implementation. YC W25, 24k+ GitHub stars, open source.',
    keywords: [
        // Company
        'Onlook team',
        'Onlook founders',
    ...
    openGraph: {
        title: 'About Onlook',
        description: 'Meet the team behind Onlook. Founded to obliterate the divide between creativity and implementation.',
        type: 'website',
...
const organizationJsonLd = {
    ...
    description: 'Onlook is an AI-powered visual editor for frontend development. Design with your real React, Vue, or Angular components. Changes become mergeable pull requests.',
    foundingDate: '2024',
    founders: [
        {
            '@type': 'Person',
