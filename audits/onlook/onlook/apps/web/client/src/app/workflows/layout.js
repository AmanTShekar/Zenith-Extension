...
exports.default = WorkflowsLayout;
exports.metadata = {
    title: 'Workflows | Integrate Onlook with Claude Code, Cursor & AI Coding Tools | Onlook',
    description: 'Connect Onlook to your AI coding workflow. Add a visual design layer to Claude Code, Cursor, and other AI tools. Design with your real components, collaborate with your team, ship PRs.',
    keywords: [
        // Primary keywords
    ...
    openGraph: {
        ...
        description: 'Connect Onlook to your AI coding workflow. Visual design layer for Claude Code, Cursor, and more.',
        images: [
            {
...
const jsonLd = {
    ...
    description: 'Connect Onlook to your AI coding workflow. Add a visual design layer to Claude Code, Cursor, and other AI tools.',
    url: 'https://onlook.com/workflows',
    mainEntity: {
        ...
        operatingSystem: 'Web',
        description: 'Onlook is an AI-powered visual editor that integrates with your AI coding workflow. Design with your real components, collaborate with your team, ship PRs.',
        featureList: [
...
function WorkflowsLayout({ children }) {
    return (<>
