...
exports.default = PrototypeFeaturesLayout;
exports.metadata = {
    title: 'AI Prototype Generator | Create Functional React Prototypes | Onlook',
    description: 'Onlook generates functional React prototypes with real interactions — not static mockups. From idea to interactive prototype in minutes. Perfect for rapid prototyping and product validation.',
    keywords: [
        // Primary keywords
    ...
    openGraph: {
        ...
        description: 'Create functional React prototypes with real interactions in minutes. Not static mockups — working applications.',
        type: 'website',
...
const jsonLd = {
    ...
    operatingSystem: 'Web',
    description: 'Onlook generates functional React prototypes with real interactions. Perfect for rapid prototyping, product validation, and user testing.',
    url: 'https://onlook.com/features/prototype',
    featureList: [
...
function PrototypeFeaturesLayout({ children }) {
    return (<>
