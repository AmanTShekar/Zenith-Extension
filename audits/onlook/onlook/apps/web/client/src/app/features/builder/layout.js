...
exports.default = BuilderFeaturesLayout;
exports.metadata = {
    title: 'Visual Builder | Design with Your Real React Components | Onlook',
    description: 'Onlook is a visual builder that works with your existing codebase. Design with your real React, Vue, or Angular components on an infinite canvas. Changes become mergeable pull requests.',
    keywords: [
        // Primary keywords
        'visual builder',
        'visual code editor',
    ...
    openGraph: {
        ...
        description: 'Design with your real React components on an infinite canvas. Changes become mergeable PRs.',
        type: 'website',
...
function BuilderFeaturesLayout({ children }) {
    return (<>
