...
exports.useFormField = exports.FormField = exports.Form = void 0;
...
function FormControl({ ...props }) {
    ...
    return (<react_slot_1.Slot data-slot="form-control" id={formItemId} aria-describedby={!error ? `${formDescriptionId}` : `${formDescriptionId} ${formMessageId}`} aria-invalid={!!error} {...props}/>);
}
