...
exports.SHELL_PROMPT = void 0;
exports.SHELL_PROMPT = `Using tools, you can suggest UNIX shell commands for users to run. Only suggest complete shell commands that are ready to execute, without placeholders.
