...
exports.generateUniqueBranchName = exports.extractNames = void 0;
const cleanNamePart = (namePart) => {
    return (namePart
        ?.trim()
 ...
 */
const generateUniqueBranchName = (baseName, existingNames) => {
 ...
 */
function extractTrueBaseName(name) {
