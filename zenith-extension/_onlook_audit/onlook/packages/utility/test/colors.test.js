...
(0, bun_test_1.describe)('ColorUtil', () => {
    ...
    (0, bun_test_1.describe)('Unknown Colors', () => {
        (0, bun_test_1.it)('should return transparent color for invalid input', () => {
            (0, bun_test_1.expect)(color_1.Color.from('not-a-color')).toEqual(color_1.Color.transparent);
            (0, bun_test_1.expect)(color_1.Color.from('not-a-color').toHex8()).toEqual('#00000000');
        });
    });
});
