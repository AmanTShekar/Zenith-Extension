...
const base_1 = require("./rect/base");
...
exports.MeasurementOverlay = (0, react_1.memo)(({ fromRect, toRect }) => {
    ...
    const fromRectAdjusted = (0, react_1.useMemo)(() => (frameView ? (0, utils_1.adaptRectToCanvas)(fromRect, frameView) : fromRect), [fromRect, frameView]);
    const toRectAdjusted = (0, react_1.useMemo)(() => (frameView ? (0, utils_1.adaptRectToCanvas)(toRect, frameView) : toRect), [toRect, frameView]);
    ...
    return (<base_1.BaseRect width={viewBox.width} height={viewBox.height} top={viewBox.minY} left={viewBox.minX} strokeWidth={0}>
            {svgContent}
        </base_1.BaseRect>);
});
