...
exports.default = BuilderFeaturesPage;
...
const builder_features_hero_1 = require("../../_components/hero/builder-features-hero");
const builder_benefits_section_1 = require("../../_components/landing-page/builder-benefits-section");
...
const builder_features_grid_section_1 = require("../../_components/landing-page/builder-features-grid-section");
const builder_features_intro_section_1 = require("../../_components/landing-page/builder-features-intro-section");
    ...
    return (<create_1.CreateManagerProvider>
            <website_layout_1.WebsiteLayout showFooter={true}>
                ...
                <div className="w-screen h-screen flex items-center justify-center" id="hero">
                    <builder_features_hero_1.BuilderFeaturesHero />
                </div>
                <responsive_mockup_section_1.ResponsiveMockupSection />
                <builder_benefits_section_1.BuilderBenefitsSection />
                <builder_features_intro_section_1.BuilderFeaturesIntroSection />
                <builder_features_grid_section_1.BuilderFeaturesGridSection />
                ...
                <faq_section_1.FAQSection faqs={builderFaqs}/>
