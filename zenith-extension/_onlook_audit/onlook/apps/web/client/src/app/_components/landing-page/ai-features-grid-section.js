...
exports.AiFeaturesGridSection = AiFeaturesGridSection;
const react_1 = __importDefault(require("react"));
function AiFeaturesGridSection() {
    return (<div className="w-full max-w-6xl mx-auto py-32 px-8">
...
//# sourceMappingURL=ai-features-grid-section.js.map