...
exports.default = ClaudeCodeWorkflowPage;
...
const claude_code_hero_1 = require("../../_components/hero/claude-code-hero");
...
function ClaudeCodeWorkflowPage() {
    return (<create_1.CreateManagerProvider>
            <website_layout_1.WebsiteLayout showFooter={true}>
                ...
                <div className="flex h-screen w-screen items-center justify-center" id="hero">
                    <claude_code_hero_1.ClaudeCodeHero />
                </div>
            ...
            },
            {
                ...
                <section className="w-full bg-black py-32">
                    <div className="mx-auto max-w-6xl px-8">
                        <div className="border-foreground-primary/10 rounded-2xl border bg-gradient-to-b from-white/5 to-transparent p-12 md:p-16">
                            <react_1.motion.div className="flex flex-col items-center text-center" {...getBlurAnimationProps()}>
                ...
                {/* FAQ Section */}
                <faq_section_1.FAQSection faqs={claudeCodeFaqs} title="Frequently asked questions"/>

                {/* CTA Section */}
                <cta_section_1.CTASection ctaText={`Try Onlook with your\nClaude Code project`} buttonText="Book a Demo" href={constants_1.ExternalRoutes.BOOK_DEMO}/>
