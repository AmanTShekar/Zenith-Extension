...
exports.default = ClaudeCodeLayout;
exports.metadata = {
    title: 'Claude Code for Designers: Add a Visual Canvas to Your Workflow | Onlook',
    description: 'Designers using Claude Code need a visual layer. Onlook gives you an infinite canvas for your AI-built UIs — with your real components, team collaboration, and PR output.',
    keywords: [
        // Primary keywords
    ...
    twitter: {
        ...
        description: 'The visual canvas your Claude Code workflow is missing. Design with your real components, collaborate with your team, ship PRs.',
        images: [
            {
                url: 'https://framerusercontent.com/images/ScnnNT7JpmUya7afqGAets8.png',
            },
...
const jsonLd = {
    ...
    operatingSystem: 'Web',
    description: 'Onlook adds a visual design layer to Claude Code. An infinite canvas for AI-built UIs with your real components, team collaboration, and direct PR output.',
    url: 'https://onlook.com/workflows/claude-code',
    featureList: [
...
function ClaudeCodeLayout({ children }) {
    return (<>
