...
[Your name]`);
    ...
    return (<website_layout_1.WebsiteLayout showFooter={true}>
                    ...
                    <div className="border border-border-primary rounded-lg p-8 sm:p-12">
                        <div className="flex flex-col lg:flex-row justify-between items-start lg:items-center gap-6 mb-8">
                            ...
                            <div className="flex flex-col sm:flex-row gap-4 lg:flex-shrink-0 w-full sm:w-auto">
                                <button_1.Button className="w-full sm:w-auto sm:min-w-[180px]" onClick={handleContactUs} variant="outline" size="lg">
                                    Contact us
                                </button_1.Button>
                                <button_1.Button className="w-full sm:w-auto sm:min-w-[180px]" size="lg" asChild>
            ...
            const IconComponent = icons_1.Icons[feature.icon];
            return (<div key={feature.title} className="flex items-start gap-4 p-0 rounded-lg">
                        ...
                        <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 mb-8 max-w-2xl mx-auto">
                            {ENTERPRISE_FEATURES.map((feature) => (<div key={feature} className="flex items-center gap-3 text-base text-foreground-secondary">
                                    <icons_1.Icons.CheckCircled className="w-5 h-5 text-foreground-onlook flex-shrink-0"/>
                                    <span>{feature}</span>
                                </div>))}
                        </div>
