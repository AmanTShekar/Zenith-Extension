...
exports.default = SitemapLayout;
exports.metadata = {
    title: 'Sitemap | Onlook',
    description: 'Complete sitemap for Onlook.com — the AI-powered visual editor for frontend development. Browse all pages including features, workflows, resources, and documentation.',
    openGraph: {
        title: 'Sitemap | Onlook',
        description: 'Complete sitemap for Onlook.com. Browse all pages including features, workflows, and resources.',
        type: 'website',
...
function SitemapLayout({ children }) {
    return (<>
