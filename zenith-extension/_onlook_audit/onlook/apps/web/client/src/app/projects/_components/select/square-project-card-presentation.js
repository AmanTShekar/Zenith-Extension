...
exports.SquareProjectCardPresentation = SquareProjectCardPresentation;
 ...
 */
function SquareProjectCardPresentation({ project, imageUrl, searchQuery = "", HighlightText, onClick, }) {
    ...
    return (<div className="cursor-pointer transition-all duration-300 group" role="button" tabIndex={0} onClick={handleClick} onKeyDown={handleKeyDown}>
            <div className={`w-full aspect-[4/2.8] rounded-lg overflow-hidden relative shadow-sm transition-all duration-300`}>
                ...
                {onClick && (<div className="absolute inset-0 bg-background/30 opacity-0 group-hover:opacity-100 transition-opacity flex items-center justify-center z-30">
                        <button onClick={(e) => {
                e.stopPropagation();
                handleClick();
...
//# sourceMappingURL=square-project-card-presentation.js.map