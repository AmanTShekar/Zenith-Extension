...
exports.SnapGuidelines = (0, mobx_react_lite_1.observer)(() => {
    ...
    return (<div className="absolute inset-0 pointer-events-none" style={{
            ...
            if (line.orientation === 'horizontal') {
                ...
                return (<div key={line.id} className="absolute bg-red-500" style={{
                        left: `${line.start}px`,
...
//# sourceMappingURL=snap-guidelines.js.map