...
exports.default = VibeCodingLayout;
exports.metadata = {
    title: 'Vibe Coding for Teams: Add Collaboration to Your AI Workflow | Onlook',
    description: 'Vibe coding has a collaboration problem. Onlook solves it. Design with your real components on an infinite canvas, work together in real-time, and ship PRs — not throwaway prototypes.',
    keywords: [
        // Primary keywords
        'vibe coding',
    ...
    openGraph: {
        ...
        description: 'Vibe coding has a collaboration problem. Onlook solves it. Design with your real components, collaborate in real-time, ship PRs.',
        images: [
            {
    ...
    twitter: {
        ...
        creator: '@onlookdev',
        title: 'Vibe Coding for Teams | Onlook',
        description: 'Vibe coding has a collaboration problem. Onlook solves it. Real components, real-time collaboration, real PRs.',
        images: [
            {
                url: 'https://framerusercontent.com/images/ScnnNT7JpmUya7afqGAets8.png',
            },
...
const jsonLd = {
    ...
    operatingSystem: 'Web',
    description: 'Onlook adds collaboration to vibe coding. Design with your real components on an infinite canvas, work together in real-time, and ship changes as mergeable pull requests.',
    url: 'https://onlook.com/workflows/vibe-coding',
    featureList: [
...
function VibeCodingLayout({ children }) {
    return (<>
