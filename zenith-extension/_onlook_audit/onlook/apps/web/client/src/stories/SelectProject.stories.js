...
exports.Playground = exports.NoImages = exports.OnlyTemplates = exports.ManyProjects = exports.FewProjects = exports.NoSearchResults = exports.WithSearch = exports.CreatingProject = exports.Empty = exports.Loading = exports.Default = void 0;
...
const meta = {
    ...
    component: select_presentation_1.SelectProjectPresentation,
    parameters: {
        layout: 'fullscreen',
        backgrounds: {
            default: 'dark',
...
const onToggleStar = (0, test_1.fn)();
const onUnmarkTemplate = (0, test_1.fn)();
const onRefetch = (0, test_1.fn)();
const onProjectClick = (0, test_1.fn)();
const onRenameProject = (0, test_1.fn)();
const onCloneProject = (0, test_1.fn)();
const onToggleTemplate = (0, test_1.fn)();
const onDeleteProject = (0, test_1.fn)();
const onUseTemplate = (0, test_1.fn)();
const onPreviewTemplate = (0, test_1.fn)();
const onEditTemplate = (0, test_1.fn)();
/**
...
exports.ManyProjects = {
    args: {
        allProjects: [
            ...mockProjects,
            ...Array.from({ length: 20 }, (_, i) => createMockProject({
                name: `Project ${i + 9}`,
                metadata: {
        ...
        isCreatingProject: false,
        onCreateBlank,
        starredTemplateIds: new Set([templateProjects[0]?.id, templateProjects[1]?.id].filter(Boolean)),
        onToggleStar,
        onUnmarkTemplate,
        onRefetch,
        onProjectClick,
...
//# sourceMappingURL=SelectProject.stories.js.map