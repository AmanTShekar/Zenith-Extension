...
const NoProjectsScreen = () => {
    ...
    return (<div className="flex flex-col w-[40rem] gap-20 mt-40">
            ...
            <div className="flex flex-row w-full gap-8">
                <card_1.Card className="w-full border border-np-primary-card-border bg-np-primary-card-background hover:bg-np-primary-card-background-hover hover:border-np-primary-card-border-hover hover:cursor-pointer flex flex-col items-center justify-center space-y-2 p-8 transition" onClick={() => {
            projectsManager.projectsTab = projects_1.ProjectTabs.PROMPT_CREATE;
                    ...
                    <div className="rounded-full p-2 bg-np-primary-icon-background">
                        <icons_1.Icons.FilePlus className="w-4 h-4 text-np-primary-icon-shape"/>
                    </div>
                ...
                <card_1.Card className="w-full border border-np-secondary-card-border bg-np-secondary-card-background hover:bg-np-secondary-card-background-hover hover:border-np-secondary-card-border-hover hover:cursor-pointer flex flex-col items-center justify-center space-y-2 p-8 transition" onClick={() => {
            projectsManager.projectsTab = projects_1.ProjectTabs.IMPORT_PROJECT;
                    ...
                    <div className="rounded-full p-2 bg-np-secondary-icon-background">
                        <icons_1.Icons.Download className="w-4 h-4 text-np-secondary-icon-shape"/>
                    </div>
...
exports.default = NoProjectsScreen;
//# sourceMappingURL=NoProjectsScreen.js.map