...
exports.NewSetupProject = void 0;
...
const NewSetupProject = ({ props, variant }) => {
    ...
    (0, react_2.useEffect)(() => {
        window.api.on(constants_1.MainChannels.CREATE_NEW_PROJECT_CALLBACK, ({ stage, message }) => {
            setMessage(message);
            if (stage === 'cloning') {
                setProgress(30);
            }
        ...
        return () => {
            window.api.removeAllListeners(constants_1.MainChannels.CREATE_NEW_PROJECT_CALLBACK);
        };
    }, []);
...
exports.NewSetupProject = NewSetupProject;
