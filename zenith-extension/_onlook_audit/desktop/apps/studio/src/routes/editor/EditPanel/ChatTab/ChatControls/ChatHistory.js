                    ...
                    <div className="flex flex-col gap-2 p-2 text-foreground-tertiary">
                        <div className="flex flex-col">
                            {groups.map((group) => (<div className="flex flex-col gap-1" key={group.name}>
                                    ...
                                    <div className="flex flex-col">
                                        {sortedConversations.map((conversation) => (<button className={(0, utils_1.cn)('flex flex-row w-full py-2 items-center rounded-md hover:bg-background-onlook cursor-pointer select-none group relative', conversation.id ===
