...
exports.TAG_INFO = {
    ...
    a: {
        title: 'Anchor',
        description: '<a>	Together with its href attribute, creates a hyperlink to web pages, files, email addresses, locations within the current page, or anything else a URL can address.',
    },
    link: {
        title: 'Link',
    ...
    li: {
        title: 'List Item',
        description: 'Represents an item in a list. It can only appear inside a list element, like <ul> or <ol>.',
    },
    img: {
        title: 'Image',
    ...
    audio: {
        title: 'Audio',
        description: 'Embeds a media player which supports audio playback into the document.',
    },
    iframe: {
        title: 'Inline Frame',
    ...
    input: {
        title: 'Input',
        description: 'An element is used to create interactive controls for web-based forms in order to accept data from the user.',
    },
    label: {
        title: 'Label',
    ...
    option: {
        title: 'Option',
        description: 'Represents an option in a <select> element, or a suggestion of a <datalist> element.',
    },
    textarea: {
        title: 'Text Area',
    ...
    svg: {
        ...
        description: 'A language for describing two-dimensional vector graphics in XML.',
    },
    path: {
        title: 'Path',
    ...
    canvas: {
        title: 'Canvas',
        description: 'Provides a resolution-dependent bitmap area, which can be used for rendering graphs, game graphics, or other visual images on the fly.',
    },
    footer: {
        title: 'Footer',
        description: 'Represents a footer for its nearest sectioning content or sectioning root element. A footer typically contains information about its section such as who wrote it, links to related documents, copyright data, and the like.',
    },
    header: {
        title: 'Header',
    ...
    main: {
        title: 'Main',
        description: 'Represents the main content of the <body> of a document or application. The main content area consists of content that is directly related to or expands upon the central topic of a document or central functionality of an application.',
    },
    section: {
        title: 'Section',
        description: "Represents a standalone section — which doesn't have a more specific semantic element to represent it — contained within an HTML document.",
    },
    article: {
        title: 'Article',
    ...
    details: {
        title: 'Details',
        description: 'Represents additional information or controls which the user can obtain on demand.',
    },
    summary: {
        title: 'Summary',
        description: 'Represents a summary, caption, or legend for the rest of the contents of the <details> element, if any.',
    },
    dialog: {
        title: 'Dialog',
    ...
    figure: {
        title: 'Figure',
        description: 'Represents self-contained content, potentially with an optional caption, which is specified using the (figcaption) element.',
    },
    figcaption: {
        title: 'Figure Caption',
        description: 'Represents a caption or legend for the rest of the contents of the <figure> element, if any.',
    },
    hr: {
    ...
    mark: {
        title: 'Mark',
        description: 'Represents highlighted text, i.e., a run of text marked for reference purpose, due to its relevance in a particular context.',
    },
    cite: {
        title: 'Citation',
        description: 'Represents the title of a work (e.g. a book, a paper, an essay, a poem, a score, a song, a script, a film, a TV show, a game, a sculpture, a painting, a theater production, a play, an opera, a musical, an exhibition, a legal case report, or a legal code).',
    },
};
