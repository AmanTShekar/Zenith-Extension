...
function getInsertedElement(actionElement, location, pasteParams, codeBlock) {
    ...
    const newClasses = (0, helpers_1.getTailwindClasses)(actionElement.oid, styles);
    const attributes = {
        className: (0, tailwind_merge_1.twMerge)(actionElement.attributes['className'], actionElement.attributes['class'], newClasses),
