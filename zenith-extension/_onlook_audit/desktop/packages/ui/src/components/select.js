...
const SelectTrigger = React.forwardRef(({ className, children, ...props }, ref) => (<SelectPrimitive.Trigger ref={ref} className={(0, utils_1.cn)('flex h-9 w-full items-center whitespace-nowrap rounded-md border border-input bg-transparent px-3 py-2 text-sm shadow-sm ring-offset-background placeholder:text-muted-foreground focus:outline-none focus:ring-1 focus:ring-ring disabled:cursor-not-allowed disabled:opacity-50 relative', className)} {...props}>
        <div className="relative flex items-center w-full">
            ...
            <SelectPrimitive.Icon asChild className="absolute right-[-6px]">
                <react_icons_1.CaretSortIcon className="h-4 w-4 flex-shrink-0 z-4"/>
